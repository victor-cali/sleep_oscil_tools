...
%Fieldtrip
addpath('D:\Dev\MATLAB\GenzelLab\fieldtrip');

%CorticoHippocampal
addpath(genpath('D:\Dev\MATLAB\GenzelLab\CorticoHippocampal'))

%CBD
addpath('D:\Dev\MATLAB\GenzelLab\CBD');
...
%Paths
patIDhpc2031 = 'D:\Dev\MATLAB\GenzelLab\data\HPC_all_animals\HPC_203_CHpyr.continuous.mat'; %pyramidal layer
patIDhpc2032 = 'D:\Dev\MATLAB\GenzelLab\data\HPC_all_animals\HPC_203_CHab.continuous.mat'; %above pyramidal layer
patIDhpc2033 = 'D:\Dev\MATLAB\GenzelLab\data\HPC_all_animals\HPC_203_CHbel.continuous.mat'; %below pyramidal layer
patIDpfc2031 = 'D:\Dev\MATLAB\GenzelLab\data\PFC_all_animals\PFC_203_CH7.continuous.mat'; %channel 5 in depth
patIDpfc2032 = 'D:\Dev\MATLAB\GenzelLab\data\PFC_all_animals\PFC_203_CH19.continuous.mat'; %channel 5 from end
...
for ii=1:3
    Data = importdata(pathsHPC203{ii});
...
for ii=1:2
    [Data, ~, ~] = importdata(pathsPFC203{ii});
    Data = filtfilt(b,a,Data);
